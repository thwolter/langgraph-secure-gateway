...
services:
  ...
  auth-gateway:
    ...
    environment:
      ...
      REFRESH_TOKEN_EXPIRE_DAYS: ${{REFRESH_TOKEN_EXPIRE_DAYS:-14}}
      REFRESH_COOKIE_NAME: ${{REFRESH_COOKIE_NAME:-lgsg_refresh_token}}
      REFRESH_COOKIE_PATH: ${{REFRESH_COOKIE_PATH:-/auth}}
...
REFRESH_COOKIE_NAME=lgsg_refresh_token
